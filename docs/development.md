...
5. Commit and push release preparation. Create and push the annotated release tag for the validated version, such as `v1.1.0`, only on that validated, pushed commit.
